        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item dropdown dropdown-user d-none d-md-block">
                        <a class="dropdown-toggle nav-link nav-link-expand dropdown-user-link" href="#" data-toggle="dropdown">
                        {{-- <a class="nav-link " href="#"> --}}
                            <span class="mr-1">
                                <span class="user-name text-bold-700">{{ LaravelLocalization::getCurrentLocaleNative() }}</span>
                            </span>
                        </a>
