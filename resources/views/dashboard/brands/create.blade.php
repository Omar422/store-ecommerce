                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('admin.brands') }}"> العلامات التجارية </a>
                                </li>
                                <li class="breadcrumb-item active"> إضافة علامة تجارية</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إنشاء علامة تجارية </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.brands.store') }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> بيانات العلامة التجارية
                                                </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
