                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> سعر المنتج </li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل سعر المنتج </h4>
                                        ...
                                        <form class="form" action="{{ route('admin.products.price.store') }}"
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> تعديل السعر
                                                </button>
                                            </div>
                                        </form>
                                    </div>
