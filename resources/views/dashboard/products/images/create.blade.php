                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل صور المنتج </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.products.images.store') }}"
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> إضافة الصور للمنتج
                                                </button>
                                            </div>
                                        </form>
                                    </div>
...
@section('script')
    ...
    <script>
        ...
        Dropzone.options.dpzMultipleFiles = {
            ...
            addRemoveLinks: true,
            acceptedFiles: 'image/*',
            dictFallbackMessage: " المتصفح الخاص بكم لا يدعم خاصيه تعدد الصورة والسحب والإفلات ",
            dictInvalidFileType: "لايمكنك رفع هذا النوع من الملفات ",
            dictCancelUpload: "إلغاء الرفع ",
            dictCancelUploadConfirmation: " هل أنت متاكد من إلغاء رفع الملفات ؟ ",
            dictRemoveFile: "حذف الصورة",
            dictMaxFilesExceeded: "لا يمكنك رفع هذا العدد من المرفقات",
