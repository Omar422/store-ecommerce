                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إنشاء قسم رئيسي </h4>
                                        ...
                                        <form class="form" action="{{ route('admin.categories.store') }}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group mt-1">
                                                            <input type="radio" name="type" value="1" class="switchery" data-color="success" checked>
                                                ...
                                                <div class="row hidden" id="categories_list">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="mainc_ategory"> اختر القسم الرئيسي </label>
                                                            <select name="parent_id" id="mainc_ategory" class="form-control">
    ...
    <script>
        $('input:radio[name="type"]').change(function(){
            if(this.checked && this.value == '2') {
                ...
                $('#categories_list').fadeIn(350).removeClass('hidden');

            } else {
                $('#categories_list').fadeOut(350).addClass('hidden');
            }
        });
    </script>
@stop
